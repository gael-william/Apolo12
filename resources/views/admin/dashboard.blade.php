                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-3 col-6">
                            <div class="small-box bg-info">
                                ...
                                {{-- <a href="{{ route('admin.publicites.index') }}" class="small-box-footer">Voir plus <i class="fas fa-arrow-circle-right"></i></a> --}}
                            </div>
                        </div>
                    </div>
                     <div class="col-12">
                    ...
                    <div class="card bg-gradient-info">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-body">
                                ...
                                <canvas class="chart tab-pane active" id="line-chart"
